...
})(exports.LiveChatMode || (exports.LiveChatMode = {}));
...
var YTFontFace;
(function (YTFontFace) {
  YTFontFace["RobotoRegular"] = "FONT_FACE_ROBOTO_REGULAR";
  YTFontFace["RobotoMedium"] = "FONT_FACE_ROBOTO_MEDIUM";
})(YTFontFace || (YTFontFace = {}));
var YTTarget;
(function (YTTarget) {
  YTTarget["NewWindow"] = "TARGET_NEW_WINDOW";
})(YTTarget || (YTTarget = {}));
exports.YTChatErrorStatus = void 0;
...
})(exports.YTChatErrorStatus || (exports.YTChatErrorStatus = {}));
var YTLiveChatBannerType;
(function (YTLiveChatBannerType) {
  YTLiveChatBannerType["ChatSummary"] = "LIVE_CHAT_BANNER_TYPE_CHAT_SUMMARY";
  YTLiveChatBannerType["CallForQuestions"] = "LIVE_CHAT_BANNER_TYPE_QNA_START";
})(YTLiveChatBannerType || (YTLiveChatBannerType = {}));
...
(function (YTIconType) {
  ...
  YTIconType["Spark"] = "SPARK";
})(YTIconType || (YTIconType = {}));

exports.SizeEnum = void 0;
(function (SizeEnum) {
  SizeEnum["SizeDefault"] = "SIZE_DEFAULT";
})(exports.SizeEnum || (exports.SizeEnum = {}));
exports.CommentActionButtonsRendererStyle = void 0;
(function (CommentActionButtonsRendererStyle) {
  ...
  exports.CommentActionButtonsRendererStyle ||
    (exports.CommentActionButtonsRendererStyle = {})
);
...
})(exports.RenderingPriority || (exports.RenderingPriority = {}));
...
function sha1Digest(payload) {
  const hash = sha1__default["default"](payload);
...
const debugLog$1 = debug__default["default"]("masterchat");
...
function parseSuperChat(renderer) {
  ...
  const color = SUPERCHAT_COLOR_MAP[originalColor];
...
// Super Sticker
function parseLiveChatPaidStickerRenderer(renderer) {
  const { timestampUsec, authorExternalChannelId: authorChannelId } = renderer;
  const timestamp = tsToDate(timestampUsec);
  const authorName = stringify(renderer.authorName);
  const authorPhoto = pickThumbUrl(renderer.authorPhoto);
...
function parseLiveChatModeChangeMessageRenderer(renderer) {
  ...
  let mode = exports.LiveChatMode.Unknown;
  if (/Slow mode/.test(text)) {
    mode = exports.LiveChatMode.Slow;
  } else if (/Members-only mode/.test(text)) {
    mode = exports.LiveChatMode.MembersOnly;
  } else if (/subscribers-only/.test(text)) {
    mode = exports.LiveChatMode.SubscribersOnly;
  } else {
    debugLog$1(
 ...
 */
function toUnknownAction(payload) {
  return {
    type: "unknown",
    payload,
  };
}
function toErrorAction(payload, error) {
  return {
    type: "error",
    error,
    payload,
...
var ListType;
(function (ListType) {
  ListType["PlaylistEditListTypeQueue"] = "PLAYLIST_EDIT_LIST_TYPE_QUEUE";
})(ListType || (ListType = {}));
var PopupType;
(function (PopupType) {
  PopupType["Toast"] = "TOAST";
})(PopupType || (PopupType = {}));
var Signal;
(function (Signal) {
  Signal["ClientSignal"] = "CLIENT_SIGNAL";
})(Signal || (Signal = {}));
var StyleTypeEnum;
(function (StyleTypeEnum) {
  StyleTypeEnum["StyleDefaultActive"] = "STYLE_DEFAULT_ACTIVE";
  StyleTypeEnum["StyleText"] = "STYLE_TEXT";
})(StyleTypeEnum || (StyleTypeEnum = {}));
var PurpleStyle;
(function (PurpleStyle) {
  PurpleStyle["BadgeStyleTypeVerified"] = "BADGE_STYLE_TYPE_VERIFIED";
  PurpleStyle["BadgeStyleTypeMembersOnly"] = "BADGE_STYLE_TYPE_MEMBERS_ONLY";
...
var FluffyStyle;
(function (FluffyStyle) {
  FluffyStyle["BadgeStyleTypeLiveNow"] = "BADGE_STYLE_TYPE_LIVE_NOW";
  FluffyStyle["BadgeStyleTypeSimple"] = "BADGE_STYLE_TYPE_SIMPLE";
})(FluffyStyle || (FluffyStyle = {}));
var ThumbnailOverlayTimeStatusRendererStyle;
(function (ThumbnailOverlayTimeStatusRendererStyle) {
  ThumbnailOverlayTimeStatusRendererStyle["Default"] = "DEFAULT";
  ThumbnailOverlayTimeStatusRendererStyle["Live"] = "LIVE";
})(
  ThumbnailOverlayTimeStatusRendererStyle ||
    (ThumbnailOverlayTimeStatusRendererStyle = {})
);
var HilariousAction;
(function (HilariousAction) {
  HilariousAction["ActionRemoveVideoByVideoID"] =
    "ACTION_REMOVE_VIDEO_BY_VIDEO_ID";
})(HilariousAction || (HilariousAction = {}));
var PlaylistID;
(function (PlaylistID) {
  PlaylistID["Wl"] = "WL";
})(PlaylistID || (PlaylistID = {}));
var AmbitiousAction;
(function (AmbitiousAction) {
  AmbitiousAction["ActionAddVideo"] = "ACTION_ADD_VIDEO";
})(AmbitiousAction || (AmbitiousAction = {}));
...
function assertPlayability(playabilityStatus, data) {
 ...
 */
function parseVideoMetadataFromHtml(html) {
...
function parseVideoMetadataFromElement(root, meta = {}) {
...
function parseVideoMetaValueByKey(key, value) {
  switch (key) {
    case "paid":
    case "unlisted":
...
exports.B64Type = void 0;
(function (B64Type) {
  B64Type["B1"] = "b1";
  B64Type["B2"] = "b2";
})(exports.B64Type || (exports.B64Type = {}));
...
function b64e(payload, type) {
  switch (type) {
    case exports.B64Type.B1:
      return urlsafeB64e(payload);
    case exports.B64Type.B2:
...
const debugLog = debug__default["default"]("masterchat:pb");
...
function sendMessageParams(to) {
  return b64e(
    concatu8([ld(1, cvToken(to)), vt(2, 2), vt(3, 4)]),
    exports.B64Type.B2
  );
}
...
function timeoutParams(channelId, origin, timeoutLength) {
  return b64e(
    concatu8([
      ld(1, cvToken(origin)),
      ld(6, [
...
function addModeratorParams(tgt, origin, undo = false) {
  ...
  b64e(
    concatu8([ld(1, cvToken(origin)), ld(2, ld(1, truc(tgt)))]),
    exports.B64Type.B2
  );
}
...
function chatToken(chatId) {
  return b64d(chatId, exports.B64Type.B1);
...
class Masterchat extends events.exports.EventEmitter {
   ...
   */
  async timeout(channelId, timeoutLength = 300) {
  ...
  async getComment(commentId) {
    ...
    if (first.renderingPriority !== exports.RenderingPriority.LinkedComment)
      return undefined;
    return first;
  }
...
exports.DisabledChatError = DisabledChatError;
exports.InvalidArgumentError = InvalidArgumentError;
exports.Masterchat = Masterchat;
exports.MasterchatError = MasterchatError;
exports.MembersOnlyError = MembersOnlyError;
exports.NoPermissionError = NoPermissionError;
exports.NoStreamRecordingError = NoStreamRecordingError;
exports.SUPERCHAT_COLOR_MAP = SUPERCHAT_COLOR_MAP;
exports.SUPERCHAT_SIGNIFICANCE_MAP = SUPERCHAT_SIGNIFICANCE_MAP;
exports.StreamPool = StreamPool;
exports.UnavailableError = UnavailableError;
exports.addModeratorParams = addModeratorParams;
exports.b64d = b64d;
exports.b64e = b64e;
exports.b64tou8 = b64tou8;
exports.bitou8 = bitou8;
exports.concatu8 = concatu8;
exports.csc = csc;
exports.delay = delay;
exports.durationToISO8601 = durationToISO8601;
exports.durationToSeconds = durationToSeconds;
exports.endpointToUrl = endpointToUrl;
exports.formatColor = formatColor;
exports.getContextMenuParams = getContextMenuParams;
exports.getTranscriptParams = getTranscriptParams;
exports.groupBy = groupBy;
exports.guessFreeChat = guessFreeChat;
exports.hextou8 = hextou8;
exports.hideParams = hideParams;
exports.liveReloadContinuation = liveReloadContinuation;
exports.liveTimedContinuation = liveTimedContinuation;
exports.parsePb = parsePb;
exports.pinParams = pinParams;
exports.pprintPbValue = pprintPbValue;
exports.printBuf = printBuf;
exports.removeMessageParams = removeMessageParams;
exports.replayReloadContinuation = replayReloadContinuation;
exports.replayTimedContinuation = replayTimedContinuation;
exports.runsToString = runsToString;
exports.sendMessageParams = sendMessageParams;
exports.stringify = stringify;
exports.timeoutParams = timeoutParams;
exports.toJSON = toJSON;
exports.toVideoId = toVideoId;
exports.transcriptFormatToken = transcriptFormatToken;
exports.tsToDate = tsToDate;
exports.tsToNumber = tsToNumber;
exports.u8tob64 = u8tob64;
exports.u8tobi = u8tobi;
exports.u8tohex = u8tohex;
exports.unpinParams = unpinParams;
